...
public class Network {
    ...
    /**
     * Constructor of the Network class which is called at the first {@link Network#getInstance()} call as Network is a singleton.
    ...
    /**
     * Initiate at the first call the {@link Network#instance} calling {@link Network#Network()}.
     ...
     * </p>
     * <p>
     * Send first a request to get the receiver public RSA key ({@link Network#publicKey}).
     * When the key is received, encrypt the calendar with {@link Network#encryptRSA()} and send it to the receiver.
     * </p>
     ...
     * The sender needs execute the function {@link Network#sender()} while this function is executing.
     * </p>
     * <p>
     * First receive a request for the public RSA key ({@link Network#publicKey}) then send it to the sender.
     * Then receive the encrypted the serialized {@link Calendar} and decrypt it with {@link Network#encryptRSA()}.
     * </p>
